...
containerHeight = float(conditions["containerHeight"])
containerRadius = float(conditions["containerRadius"])
...
for i in range(nImages):
    ...
    outfile.write("  location <{},{},{}> \n".format(containerHeight*5,containerHeight*2,containerHeight*2))
    ...
    outfile.write("  <{},{},{}>   \n".format(containerHeight*15,-containerHeight*2,containerHeight*2))
    outfile.write("  color White \n")
    outfile.write("}\n")
    outfile.write("background { color White }\n" )

    outfile.write("cylinder{{<0.0,0.0,{}>,<0.0,0.0,{}>,{} texture {{pigment{{color White filter 0.8}} finish {{phong 1.0}} }} }}".format(containerHeight/2.0,-containerHeight/2.0,containerRadius))
