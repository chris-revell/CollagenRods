...
function main(N,L,σ,ϵ,p,η,kT,tMax,boxSize)
    ...
    while t < tMax
        ...
        #repulsiveForces!(pairsList,N,r,Ω,F,τ,E,ϵ,σ,DParallel,DPerpendicular,DRotation,kT)
        #attractiveForces!(pairsList,N,r,Ω,F,τ,E,DParallel,DPerpendicular,DRotation,kT,L)
